    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                ...
                <p class="mb-0">
                    Presents data on the supporting devices used in the
                    laboratory.
                </p>
            </div>
            <div>
    ...
    <div class="card border-0 shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table
                    class="table-laboratory-supporting-devices table-centered table-nowrap mb-0"
                    id="table-laboratory-supporting-devices"
                >
                    <thead>
                        <tr>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a
                                        href="{{ route('laboratory-supporting-devices.create', ['laboratory_room' => $item->id]) }}"
    ...
    $(document).ready(function () {
        ...
        function load_data(from_date = "", to_date = "") {
            $("#table-laboratory-supporting-devices").DataTable({
                ...
                ajax: {
                    url: "{{ route('laboratory-supporting-devices.index') }}",
